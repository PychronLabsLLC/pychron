...
class ArArAgeCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        expected_filtered_56954_01A = dict(
            Ar40bs_c=2.20831,
            Ar39bs_c=4.96090e-3,
            Ar38bs_c=0.0014621,
            Ar37bs_c=1.34848e-3,
    ...
    def test_Ar40blank(self):
        ...
        self.assertAlmostEqual(iso.value, self.expected["Ar40bl"], 6)

    def test_Ar40blank_error(self):
        an = self.analysis
        iso = an.isotopes["Ar40"].blank

        self.assertAlmostEqual(iso.error, self.expected["Ar40ble"], 6)
    ...
    def test_Ar40bl_e(self):
        ...
        self.assertAlmostEqual(
            iso.get_non_detector_corrected_value().std_dev, self.expected["Ar40bl_ce"], 6
        )
    ...
    def test_Ar40_e(self):
        ...
        self.assertAlmostEqual(
            iso.get_baseline_corrected_value().std_dev, self.expected["Ar40bs_ce"], 6
        )
    ...
    def test_Ar39_e(self):
        ...
        self.assertAlmostEqual(
            iso.get_baseline_corrected_value().std_dev, self.expected["Ar39bs_ce"], 6
        )
    ...
    def test_ar37decayfactor(self):
        an = self.analysis
        self.assertAlmostEqual(an.ar37decayfactor, self.expected["ar37df"], 3)
    ...
    def test_Multiplier_baseline(self):
        an = self.analysis
        self.assertAlmostEqual(an.isotopes["Ar40"].baseline.value, self.expected["Ar40bs"], 4)

    def test_Ar40_baseline_corrected(self):
        an = self.analysis
        self.assertAlmostEqual(
            an.isotopes["Ar40"].get_baseline_corrected_value().nominal_value,
            self.expected["Ar40bs_c"],
            4,
        )
    ...
    def test_Ar39_baseline_corrected(self):
        an = self.analysis
        self.assertAlmostEqual(
            an.isotopes["Ar39"].get_baseline_corrected_value().nominal_value,
            self.expected["Ar39bs_c"],
            7,
        )
    ...
    def test_Ar37_baseline_corrected(self):
        an = self.analysis
        self.assertAlmostEqual(
            an.isotopes["Ar37"].get_baseline_corrected_value().nominal_value,
            self.expected["Ar37bs_c"],
            7,
        )
    ...
    def test_Ar38_baseline_corrected(self):
        an = self.analysis
        self.assertAlmostEqual(
            an.isotopes["Ar38"].get_baseline_corrected_value().nominal_value,
            self.expected["Ar38bs_c"],
            7,
        )
    ...
    def test_Ar36_baseline_corrected(self):
        an = self.analysis
        self.assertAlmostEqual(
            an.isotopes["Ar36"].get_baseline_corrected_value().nominal_value,
            self.expected["Ar36bs_c"],
            7,
        )
    ...
    def test_39_40(self):
        def _func(an):
            ...
            #                 )
            self.assertEqual(e, self.expected["Ar39_Ar40e"])
